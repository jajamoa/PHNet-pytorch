...
parser.add_argument('gt_code', metavar='GT_NUMBER' ,type=str,
                    help='ground truth dataset number')

parser.add_argument('--logname',metavar='LOGNAME', type=str,
                    help='Log name to save.')
